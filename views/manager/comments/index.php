...
$search = $_GET['s'] ?? '';
$totalPage = getTotalPageComment(htmlspecialchars($search));
...
$comments = handleGetCommentByPage(htmlspecialchars($search), $page);
$total = count($comments);

$totalComment = count(handleGetCommentByPage('', $totalPage > 0 ? $totalPage : 1)) + 40 * (($totalPage - 1 >= 0 ? ($totalPage - 1) : 0));
...
<head>
  ...
  <script src="./../../../js/manager/comments/index.js"></script>
  ...
  <div class="manager grid grid-cols-5 gap-3 mt-[var(--height-header)] ">
    ...
    <div class="manager-container col-span-4 ">
      <div class="manager-content pt-3">
        <div class="text-[40px] tracking-wide font-bold font-sans mb-2">Danh sách bình luận</div>
        <div class="group-content w-[calc(100%-12px)]">
          <div class="action mt-1 mb-6 flex">
            <div class="flex flex-1">
              <a href="./add.php" class="btn primary flex items-center"><i class="fa-solid fa-plus"></i> Thêm bình luận</a>
              <form class="relative" action="./../../../handle/comment_handle.php" method="GET">
            ...
            <div class=""><p class="btn outline flex items-center !cursor-default"><?=$totalComment?> bình luận</p></div>
          </div>
                ...
                <tbody>
                  ...
                  ?>
                      <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 border-gray-200 hover:bg-gray-50 dark:hover:bg-gray-600">
                        ...
                        <td class="px-6 py-4">
                          <?= htmlspecialchars($comments[$i]['nameLesson']) ?>
                        </td>
                        <td class="px-6 py-4">
                          <?= htmlspecialchars($comments[$i]['username']) ?>
                        </td>
                        <td class="px-6 py-4">
                          <?= htmlspecialchars($comments[$i]['createAt']) ?>
                        </td>
                        <td class="px-6 py-4 text-right action-object">
                          <a href="./edit.php?id=<?= $comments[$i]['idComment'] ?>" class=""><i class="fa-solid fa-pen-to-square action-object-item"></i></a>
                          <!-- <a href="#" class=""><i class="fa-solid fa-circle-info action-object-item"></i></a> -->
                          <button
                            data-modal-target="popup-modal"
                            data-modal-toggle="popup-modal"
                            data-comment-id="<?= htmlspecialchars($comments[$i]['idComment']) ?>"
