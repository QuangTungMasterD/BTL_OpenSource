...
checkLogin();
isAdminLogin();
require __DIR__ . '/../../../handle/topic_handle.php';
$topic = handleGetTopicById($idEdit);
...
<body>
  <div class="max-w-[600px] overflow-hidden mx-auto bg-white p-6 mt-12 rounded-xl mb-12">
    <h1 class="text-3xl mb-6 text-[rgb(var(--primary-color))] flex justify-center font-[450] uppercase">Sửa chủ đề</h1>
    <form action="./../../../handle/topic_handle.php" method="POST">
      ...
      <div class="form-input">
        ...
        <input name="nameTopic" class="input" placeholder="Nhập nội dung bình luận" value="<?=htmlspecialchars($old['nameTopic'] ?? $topic['nameTopic'] ?? '') ?>">
      ...
      <div class="form-input">
        ...
        <input name="color" class="input" placeholder="Nhập màu chủ đề rga 0, 0, 0; 255, 0, 0; ..." value="<?=htmlspecialchars($old['color'] ?? $topic['color'] ?? '') ?>">
